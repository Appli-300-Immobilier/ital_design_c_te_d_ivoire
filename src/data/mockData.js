// Catalogue de 100 biens pour Ital Design C�te d'Ivoire
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@italdesignctedivoire.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
